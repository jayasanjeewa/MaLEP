...
X = df[['processor_speed', 'no_of_cores', 'memory', 'age_months']].astype(float)
...
for row in df_test.itertuples():
    ...
    predicted_fully_utilized_power = regr.predict([[test_processor_speed, test_cores_count, test_memory, test_age]])
    ...
    print (test_processor_speed, ",", test_cores_count, ",",  test_memory, ",", test_age, ",", fully_utilized_power, ",", predicted_fully_utilized_power, ",", str(error_percentage))
