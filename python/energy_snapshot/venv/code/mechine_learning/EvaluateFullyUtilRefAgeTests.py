...
X = df[['power_supply_rating']].astype(float)
...
for row in df_test.itertuples():
    ...
    predicted_fully_utilized_power = regr.predict([[test_power_rating]])
    ...
    print (test_power_rating,  ",", fully_utilized_power, ",", predicted_fully_utilized_power, ",", str(error_percentage))
